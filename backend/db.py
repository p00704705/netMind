...
cursor.execute("INSERT INTO latency (target, latency_ms) VALUES (?, ?)", ("8.8.8.8", 56.3))
conn.commit()
...
collection.insert_one({"target": "8.8.8.8", "latency": 56.3, "timestamp": "2025-05-25T11:30:00Z"})
